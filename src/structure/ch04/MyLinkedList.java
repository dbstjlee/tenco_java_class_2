...
public class MyLinkedList {
	...
	public Node removeElement(int index) {
		...
		// [티모][소라카] 
		return tempNode; // 찾았던 tempNode를 리턴시킴 => 여기서 야스오를 리턴??
	}
