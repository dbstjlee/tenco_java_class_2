...
public class MyArrayListTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("값 추가 확인 : " + list); // list : 참조 변수 - 주소값(4byte) 근데 toString 이 정의되어 있다.
		Student student = new Student("홍박사");
		System.out.println(student);

		// 값 삭제
		list.remove(2); // index 기반 -> index 2번째 요소 삭제
		...
		System.out.println(list.size()); // size 는 배열의 크기? 요소의 개수? -> 요소의 개수를 나타냄
		// -> size : 2(요소의 개수)
		...
		list.add(10000);// 출력한 후 다시 추가하는 요소를 호출함
